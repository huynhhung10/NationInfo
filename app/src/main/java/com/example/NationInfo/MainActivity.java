        ...
        protected void onPostExecute(Object o) {
            ...
            lvNation.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int i, long id) {
                    ...
                    intent.putExtra("Map", nationArrayList.get(i).getMapUrl());
                    intent.putExtra("Capital", nationArrayList.get(i).getCapital());
    ...
    protected Void getWebServiceResponseData(){
        ...
        try{
            ...
            for (int i = 0; i < jsonArray.length(); i++){
                ...
                String capital = jsonCountryObject.getString("capital");

                //get image from geonames.org
                String flagUrl = "https://img.geonames.org/flags/x/" +
                        countryCode.toLowerCase() + ".gif";

                String mapUrl = "https://img.geonames.org/img/country/250/" +
                        countryCode.toLowerCase() + ".png";

                Nation nationObj = new Nation(name, population, flagUrl, area, capital,  mapUrl);
